...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 10, 2022 at 08:06 AM
...
(1, 'Little Haathee', 'Our story begins with a bunch of socially responsible geeks who came together to realise that the world needs to support art, creativity and those who dream of it, and it is not going to happen on it’s own. That’s why we aims to target and work around it at the foundation, our little minds with much more potential but faces lack of resources', 1);
...
INSERT INTO `artists` (`artist_id`, `artist_name`, `description`, `video_link`, `artist_image`) VALUES
(1, 'Naveen', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s,', 'OzzaPLEhQKY', '10.jpg'),
(2, 'Sriraj', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s,', 'OzzaPLEhQKY', '11.jpg'),
(3, 'Sunny', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s,', 'OzzaPLEhQKY', '12.jpg');
...
INSERT INTO `artwork` (`artwork_id`, `title`, `description`, `artist`, `image`, `created_by`, `created_date_time`) VALUES
(1, 'Artwork 1', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s', 1, '6b69869806e531b4a3bf993ec8215dab1.jpg', 1, '2021-11-20 16:07:47'),
(3, 'Artwork 2', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s', 2, 'unnamed3.jpg', 1, '2021-11-20 16:08:05'),
(4, 'Artwork 3', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s', 1, 'graphic-design-illustration-in-UI-design-article-1024x768.jpg', 1, '2021-11-20 16:08:58'),
(5, 'Artwork 4', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s', 1, '6bfbf4a23e6a1fa60fd0a20bbc8c891b.jpg', 1, '2021-11-20 16:09:07'),
(6, 'Artwork 5', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s', 1, 'f05897a7c4df0376c836e7bd8028c618.jpg', 1, '2021-11-20 16:11:01'),
(7, 'Artwork 6', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s', 1, 'lion-artwork-design-illustration-template-for-t-shirt-clothing-apparel-and-merchandise-vector.jpg', 1, '2021-11-20 16:30:23'),
(8, 'Artwork 7', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s', 1, 'galshir-astronaut_2x-600x450.png', 1, '2021-11-20 16:30:35'),
(9, 'Artwork 8', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s', 1, 'c5bb90c313e6c590ddaf2cde13d593d2.jpg', 1, '2021-11-20 16:30:46');
...
INSERT INTO `cart` (`cart_id`, `product_id`, `stock_id`, `qty`, `user_id`, `status`, `created_date`) VALUES
(1, 2, 4, 4, 1, 1, '2021-12-24'),
(2, 3, 7, 1, 1, 1, '2021-12-24'),
(3, 1, 1, 4, 4, 1, '2021-12-24'),
(4, 2, 4, 1, 4, 1, '2021-12-24'),
(5, 4, 12, 2, 1, 1, '2021-12-26'),
(6, 2, 4, 1, 1, 1, '2022-01-03'),
(7, 2, 4, 1, 1, 0, '2022-01-03');
...
(2, 'Men', '', '1231.jpg', 1, '2021-10-14 07:41:05'),
(3, 'Women', '', '1241.jpg', 1, '2021-10-14 07:41:16'),
(4, 'Kids', '', '101.jpg', 1, '2021-10-14 07:41:21');
...
(1, 'Naveen', 6302758875, 'nvnsoftsol@gmail.com', '81dc9bdb52d04dc20036dbd8313ed055', 1, '2021-10-20 08:12:27'),
(2, 'Sriraj', 9876543210, 'nvnsoftsol@gmail.com', '81dc9bdb52d04dc20036dbd8313ed055', 1, '2021-10-20 09:34:06'),
(4, 'Priya', 9121659472, 'naveenreddy@umdaa.co', '81dc9bdb52d04dc20036dbd8313ed055', 1, '2021-12-24 07:02:10');
...
CREATE TABLE `forms` (
  ...
  `project_style` varchar(255) NOT NULL,
  `message` text NOT NULL,
  `anything_more` text NOT NULL,
  `referral_code` varchar(255) NOT NULL,
  `executive_code` varchar(255) NOT NULL,
  `status` int(11) NOT NULL,
  `created_by` int(11) NOT NULL,
  `created_date_time` datetime NOT NULL,
...
INSERT INTO `forms` (`form_id`, `application_number`, `project_type`, `looking_for`, `pro_description`, `budget`, `project_style`, `message`, `anything_more`, `referral_code`, `executive_code`, `status`, `created_by`, `created_date_time`, `approved_by`, `approved_date_time`) VALUES
(1, '16233616661', 'interior', '2D', 'Residential', 25000, 'ongoing_work', 'Comfort Project', 'It should be spacious', 'MXC25878', 'S798', 1, 1, '2021-06-10 23:47:46', 0, '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `forms_images`
--

CREATE TABLE `forms_images` (
  `forms_images_id` int(11) NOT NULL,
  `form_id` int(11) NOT NULL,
  `image` varchar(255) NOT NULL,
  `created_by` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Dumping data for table `forms_images`
--

INSERT INTO `forms_images` (`forms_images_id`, `form_id`, `image`, `created_by`) VALUES
(1, 1, 'v4-2.jpg', 1),
(2, 1, 'v4-3.jpg', 1);
...
INSERT INTO `gallery` (`gallery_id`, `image`, `created_by`, `created_at`) VALUES
(2, '', 1, '2021-06-02 11:20:07'),
(3, '10_-_Copy.jpg', 1, '2021-06-02 11:20:55'),
(4, '10.jpg', 1, '2021-06-02 11:20:55');
...
CREATE TABLE `general_settings` (
  ...
  `logo_general` varchar(255) NOT NULL,
...
INSERT INTO `general_settings` (`general_setting_id`, `title`, `description`, `keywords`, `logo_dark`, `logo_general`, `theme_color`) VALUES
(1, 'Little Haathee', 'Printed tees are the trend and now it would come with a purpose, a purpose to appreciate/support a little kid’s mind and creativity', 'Little Haathee', 'Logo-Dark-55', 'Logo-General-16', '#ffffff');
...
INSERT INTO `guidance` (`id`, `title`, `description`, `image`, `created_at`) VALUES
(1, 'Our Featured Services', '', 'single-service-1.jpg', '2021-06-09 14:36:44');
...
INSERT INTO `learn_more` (`id`, `title`, `description`, `image`, `created_at`) VALUES
(1, 'Our Featured Services', '', 'single-service-1.jpg', '2021-06-09 14:36:44');
...
INSERT INTO `orders` (`order_id`, `tracking_id`, `status`, `address_id`, `amount`, `transaction_id`, `razorpay_order_id`, `payment_mode`, `created_by`, `created_date_time`) VALUES
(1, 'LH-ORD001', 1, 4, 0, '', '', '', 1, '2021-11-23 06:45:52'),
(2, 'LH-ORD002', 1, 13, 0, 'pay_29QQoUBi66xm2f', 'order_9A33XWu170gUtm', 'Net Banking', 4, '2021-12-24 07:44:41'),
(3, 'LH-ORD003', 0, 0, 0, '', '', '', 4, '2021-12-24 08:02:18'),
(4, 'LH-ORD004', 0, 0, 0, '', '', '', 1, '2021-12-25 07:58:22'),
(5, 'LH-ORD005', 0, 0, 0, '', '', '', 1, '2021-12-30 05:56:47'),
(6, 'LH-ORD006', 0, 0, 0, '', '', '', 1, '2022-01-03 07:32:44');
...
INSERT INTO `order_line_items` (`order_line_item_id`, `order_id`, `product_stock_id`, `price`, `qty`) VALUES
(1, 1, 4, 1480, 3),
(2, 1, 1, 900, 2),
(3, 2, 1, 900, 4),
(4, 3, 4, 1480, 1),
...
INSERT INTO `payment_settings` (`payment_setting_id`, `secret_id`, `key_id`) VALUES
(1, 'secret id', 'Key id');
...
INSERT INTO `products` (`product_id`, `product_name`, `category`, `description`, `status`, `artist_id`, `artwork_id`, `created_by`, `created_date_time`, `featured_image`) VALUES
(1, 'Womens Shirt', 3, 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book', 'published', 1, 3, 1, '2021-11-01 07:30:56', 'LH177815.jpg'),
(2, 'Mens T-shirt', 3, 'Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset', 'coming_soon', 2, 3, 1, '2021-11-01 07:46:08', 'LH24608.jpg'),
(4, 'T-Shirt', 2, 'Sample T-Shirt', 'out_of_stock', 2, 0, 1, '2021-12-25 08:23:35', 'LH8846LH24608.jpg');
...
INSERT INTO `product_stock` (`product_stock_id`, `product_id`, `product_size`, `qty_supplied`, `price`, `sp_price`, `color`, `sku_code`, `product_images`) VALUES
(1, 1, 'XS', 100, 980, 900, '#000000', 'LH01XS0', 'LH65189.jpg'),
(2, 1, 'S', 150, 980, 900, '#000000', 'LH01S1', 'LH65189.jpg'),
(3, 1, 'XS', 100, 480, 320, '#ffffff', 'LH01XS2', 'LH11806.jpg,LH841911.jpg,LH5057124.jpg'),
(4, 2, 'XL', 100, 1500, 1480, '#000000', 'LH02XL3', 'LH5335123.jpg,LH3771125.jpg'),
(5, 2, 'XXL', 150, 1500, 1480, '#000000', 'LH02XXL4', 'LH5335123.jpg,LH3771125.jpg'),
(6, 2, 'XL', 100, 1400, 1320, '#ff0000', 'LH02XL5', 'LH213610.jpg,LH5712123.jpg'),
(7, 3, 'XS', 100, 2500, 2200, '#000000', 'LH03XS6', 'LH3735designs_08.jpg,LH1616ecommerce-poster.jpg'),
(8, 3, 'S', 100, 2500, 2200, '#000000', 'LH03S7', 'LH3735designs_08.jpg,LH1616ecommerce-poster.jpg'),
(9, 3, 'L', 150, 2500, 2200, '#000000', 'LH03L8', 'LH3735designs_08.jpg,LH1616ecommerce-poster.jpg'),
(10, 3, 'XL', 180, 2500, 2200, '#000000', 'LH03XL9', 'LH3735designs_08.jpg,LH1616ecommerce-poster.jpg'),
(11, 3, 'XXXL', 200, 2500, 2200, '#000000', 'LH03XXXL10', 'LH3735designs_08.jpg,LH1616ecommerce-poster.jpg'),
(12, 4, 'XS', 100, 2500, 2400, '#000000', 'LH04XS11', 'LH3919LH3771125.jpg'),
(13, 4, 'S', 100, 2500, 2400, '#000000', 'LH04S12', 'LH3919LH3771125.jpg'),
(14, 4, 'M', 150, 2500, 2400, '#000000', 'LH04M13', 'LH3919LH3771125.jpg'),
(15, 4, 'L', 180, 2500, 2400, '#000000', 'LH04L14', 'LH3919LH3771125.jpg'),
(16, 4, 'XL', 200, 2500, 2400, '#000000', 'LH04XL15', 'LH3919LH3771125.jpg');
...
INSERT INTO `profiles` (`profile_id`, `profile_name`, `status`, `created_at`) VALUES
(1, 'superadmin', 1, '2021-06-01 17:25:13'),
(2, 'manager', 1, '2021-06-01 17:25:13'),
(3, 'executive', 1, '2021-06-01 17:25:13');
...
INSERT INTO `project_images` (`image_id`, `project_id`, `image`, `created_by`) VALUES
(5, 1, 'v5-8.jpg', 1),
(6, 1, 'v6-1.jpg', 1),
(7, 1, 'v6-4.jpg', 1),
(9, 1, 'v2-3.jpg', 1),
...
INSERT INTO `referral_codes` (`code_id`, `code`, `limitations`, `percentage`, `description`, `status`, `created_at`) VALUES
(2, 'NVN54845184sfd', 20, 30, 'Lorem Ipsum', 1, '2021-06-01 17:44:55');
...
(1, 'LittleHathee', 'Sample Description', 'LH_S5939shopBG.jpg', '2021-11-04 09:15:54'),
(2, 'LittleHathee', 'Sample Description', 'LH_S8657shop.jpg', '2021-11-04 10:09:59'),
(3, 'LittleHathee', 'Sample Description', 'LH_S5843slide1.jpg', '2021-11-04 10:10:14');
...
(13, 4, 'Hari Priya Kamireddy', 9121659472, 'Ashok Nagar, Kakinada', 'Kakinada', 'Telangana', 533003);
...
--
-- Indexes for table `forms_images`
--
ALTER TABLE `forms_images`
  ADD PRIMARY KEY (`forms_images_id`);
...
--
-- AUTO_INCREMENT for table `forms_images`
--
ALTER TABLE `forms_images`
  MODIFY `forms_images_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `order_line_items`
  MODIFY `order_line_item_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `payment_settings`
--
ALTER TABLE `payment_settings`
  MODIFY `payment_setting_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `user_address`
  MODIFY `user_address_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
COMMIT;
